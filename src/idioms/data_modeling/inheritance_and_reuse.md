...
implementations in Rust are composition, aggregation, and [generics](TODO).
...
vtable for [trait objects](./idioms/data_modeling/pure_virtual_classes.md) in
Rust includes all methods defined by the trait.
...
Rust traits are more differ from abstract classes in a few ways. For example,
